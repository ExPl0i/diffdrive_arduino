...
public:
    ...
    std::pair<double, double> computeVehicleSpeedAndOmega(double V_FL, double V_FR, double V_RL, double V_RR, double theta_f, double theta_r, double L_f, double L_r, double W);
